...
const rows = [
  createData(0, '16 Mar, 2019', 'Elvis Presley', 'ADMIN', 'VISA ⠀•••• 3719', 312.44),
  createData(1, '16 Mar, 2019', 'Paul McCartney', 'ADMIN', 'VISA ⠀•••• 2574', 866.99),
  createData(2, '16 Mar, 2019', 'Tom Scholz', 'ADMIN123', 'MC ⠀•••• 1253', 100.81),
  createData(3, '16 Mar, 2019', 'Michael Jackson', 'ADMIN123', 'AMEX ⠀•••• 2000', 654.39),
  createData(4, '15 Mar, 2019', 'Bruce Springsteen', 'ADMIN', 'VISA ⠀•••• 5919', 212.79),
];
  ...
  return (
    <React.Fragment>
            ...
            <MaterialTable
              ...
              columns={columns}
              data={data}
              title=<div style={{padding: '0px 2px'}}>
                          <Input
                              id="predial"
                              type="radio"
                              value="PREDIA"
